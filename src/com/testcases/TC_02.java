...
public class TC_02
{
	...
	public void testItemsAdd()
	{
		...
		assertEquals("Item not added", 1, items.addNewItem("Mouse"));
		assertEquals("Item not added", 1, items.addNewItem("Keyboard"));
		assertEquals("Item not added", 1, items.addNewItem("Monitor"));
		assertEquals("Item not added", 1, items.addNewItem("CPU"));
		assertEquals("Item not added", 1, items.addNewItem("HDMI"));
	}
	...
	public void testCheckout()
	{
		...
		assertEquals("Some items did not have valid stocks available", 3, result);
	}
